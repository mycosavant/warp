...
`.fork/decisions/`. No standing horizon right now. ~~`next.html` is the live plan.~~ The
2026-09-13 handoffs below carry the work; `next.html` stays live only until
its specs clause is met (checked 2026-09-14).
...
it; the maintainer asks for a cloud copy when one is wanted. All seven items
are done, and since 2026-09-14 its chips say so.
...
**Nine finished handoffs are in `archive/`**, moved 2026-09-14 under
`HANDOFF-HYGIENE.md` Part A after each was checked against its closing
commits: `HANDOFF-MOBILE.md` (steps 1-6; the device rows live on in
`docs/remote-control.md`), `HANDOFF-PROFILE.md` (the app crate bounded,
`c25c8fbc2`), `HANDOFF-SPECSFETCH.md` (`87d4d2049`), `HANDOFF-LOCALMODEL.md`
(done 2026-09-09; still the recipe for a local model in the panel),
`HANDOFF-AUTH.md`, `HANDOFF-DECIDE.md` (seven questions ruled),
`HANDOFF-NEXT.md`, `HANDOFF-GHTESTS.md` and `HANDOFF-FOCUS.md` (the
window-focus fix and its live pass). What they left open is carried by the
`docs/` pages, the 2026-09-13 handoffs below, or `tickets/T15-loose-ends.md`.
...
| `T04-local-drive.md` | account-free Warp Drive, with the T4.4 git-sync scope and as-built | done (every box ticked, checked 2026-09-14) |
...
| `T13-run-gate.md` | the run gate | ~~active~~ done (all boxes ticked; relabelled 2026-09-14) |
...
`GOAL.md` until it is retired, then here — as of 2026-09-12, all six. Nine
more are dated 2026-09-13, the maintainer's calls that evening: the security
posture, the TUI tested before first-class, the endpoint watcher, `graph run`
keeping the machine awake, the twelve-hour control pairing, the local-model
disclosure, no package-manager launches for ACP agents, a native Android app
as a destination, and acknowledging a session Warp is not asked in.
...
soft-fork decision and the corrected divergence measurement), the retired
`GOAL-2026-09-04.md`, eleven finished handoffs (CLASSIFIER and COMPOSER from
the 2026-09-05 layout, nine more moved 2026-09-14), and the August friction
logs.
