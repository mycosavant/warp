...
| `docs/voice.md` | **speech in and speech out as one surface**: the 2026-09-13 desk decisions (OpenWhispr for dictation, an owned pocket-tts CLI for read-aloud), why Warp does not talk to speech-kit's sidecar or OpenWhispr's engine, the phone app and its four device constraints, and three findings kept for their shape rather than their subject |
