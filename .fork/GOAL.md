...
| 6 | The viewer: one trace from the harness's record and Warp's (`.fork/docs/observability.md`) | phase 0 **done** 2026-09-05, `7bb323cbc`, `.fork/runs/viewer-phase0-2026-09-05/`; phase 1 **done** the same day, `warpctrl agent trace`; phase 2 (`--pretty`, `--html`) next |
