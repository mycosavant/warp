...
**No known path in the fork reaches Warp's servers, and the two things that
were stopping it were both accidents.** Closed 2026-09-04. This line said "the
fork no longer talks to Warp's servers at all" until 2026-09-13; known means
through the three enforcement points, and the raw clients in the seams table
are not covered.
